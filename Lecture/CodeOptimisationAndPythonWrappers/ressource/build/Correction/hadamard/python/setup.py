...
URL = ''
DESCRIPTION = 'Asterics HPC hadamard python module'
LICENSE = 'Cecil-C'
...
packageName = 'hadamardpython'
ext_modules = [
	Extension(packageName, ['@CMAKE_CURRENT_SOURCE_DIR@/hadamardpython.cpp',
				'@CMAKE_CURRENT_SOURCE_DIR@/hadamard_intrinsics_pitch.cpp',
				'@CMAKE_CURRENT_SOURCE_DIR@/hadamardWrapper.cpp'
	],
	libraries=[],
	library_dirs=[],
