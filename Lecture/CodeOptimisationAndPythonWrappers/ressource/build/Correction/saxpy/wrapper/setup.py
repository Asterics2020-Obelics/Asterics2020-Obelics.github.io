...
URL = ''
DESCRIPTION = 'Asterics HPC saxpy python module'
LICENSE = 'Cecil-C'
...
packageName = 'saxpypython'
ext_modules = [
	Extension(packageName, ['@CMAKE_CURRENT_SOURCE_DIR@/saxpypython.cpp',
				'@CMAKE_CURRENT_SOURCE_DIR@/saxpy_intrinsics.cpp',
				'@CMAKE_CURRENT_SOURCE_DIR@/saxpyWrapper.cpp'
	],
	libraries=[],
	library_dirs=[],
